...
export default function AdminUsersPage() {
  ...
  return (
    <section className="py-12 overflow-visible">
      ...
      <div>
        <h1 className="text-lg font-semibold text-white mb-2">User Management</h1>
        <p className="text-sm text-zinc-400">Manage users, ban/unban, and give tokens</p>
      </div>
      ...
      {loading ? (
        <div className="text-center text-sm text-zinc-400 py-8">Loading users...</div>
      ) : (
        <>
